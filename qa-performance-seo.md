...
Alle acht Nicht-Home-Seiten werden per React `lazy()` geladen. Eine testweise manuelle Vendor-Chunk-Aufteilung wurde nach einem kritischen Produktionsproblem vollständig entfernt. Die Website verwendet wieder Vites stabile Standard-Chunk-Strategie; der gemeinsame Einstiegschunk erzeugt dabei eine Größenwarnung, während sämtliche Inhaltsseiten weiterhin separat geladen werden.
